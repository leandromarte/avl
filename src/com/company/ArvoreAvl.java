  ...
  protected No raiz;
	...
	public void printInOrder(No n) {
		if (n.getEsquerda() != null) {
			printInOrder(n.getEsquerda());
		}

		System.out.println(n.getChave());

		if (n.getDireita() != null) {
			printInOrder(n.getDireita());
		}
	}

	public void printPreOrder(No n) {
		System.out.println(n.getChave());

		if (n.getEsquerda() != null) {
			printPreOrder(n.getEsquerda());
		}

		if (n.getDireita() != null) {
			printPreOrder(n.getDireita());
		}
	}

	public void printPosOrder(No n) {
		if (n.getEsquerda() != null) {
			printPosOrder(n.getEsquerda());
		}

		if (n.getDireita() != null) {
			printPosOrder(n.getDireita());
		}
